...
test('Promo Test 04 - Invalid promo code is rejected', async ({ page }) => {
  ...
  await promoPage.enterPromoCode('FAKECODE');
  ...
  await promoPage.expectPromoResult('Invalid promo code');
});